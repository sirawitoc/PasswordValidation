...
public class TestRunner {
    ...
    public static void main(String[] a) {
        ...
        check("password len = 20", PasswordValidator.validate("Abcdef12345678910111")== true);
        check("password len > 20", PasswordValidator.validate("AbAbcdef1234567891011")== false);
        // TODO: R3 - ไม่มีตัวพิมพ์ใหญ่ -> false
        check("password no upper", PasswordValidator.validate("aaaaabbbbb1234")== false);
        // TODO: R4 - ไม่มีตัวพิมพ์เล็ก -> false
        check("password no lower", PasswordValidator.validate("AAAABBBBB1234")== false);
        // TODO: R5 - ไม่มีตัวเลข -> false
        check("password no number", PasswordValidator.validate("AAAAABBBBaaabbb")== false);
        // TODO: R6 - มีช่องว่าง -> false
        check("password is empty ", PasswordValidator.validate(" ")== false);
        // TODO: boundary อื่นๆ ที่คุณคิดว่าจำเป็น
        check("password is 67 ", PasswordValidator.validate(" 67")== false);
